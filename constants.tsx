...
export const navLinks: { title: string; links: { name: Page, path: string, icon: React.FC<React.SVGProps<SVGSVGElement>> }[] }[] = [
  {
    title: 'Main',
    links: [
      { name: 'Dashboard', path: '/dashboard', icon: Icons.dashboard },
      { name: 'Reports', path: '/reports', icon: Icons.reports },
      { name: 'AttendanceLog', path: '/attendance-log', icon: Icons.attendance },
      { name: 'ManageUsers', path: '/manage-users', icon: Icons.users },
    ],
  },
  {
    title: 'Academics',
    links: [
      ...
      { name: 'SBTETResults', path: '/results', icon: Icons.results },
      { name: 'Syllabus', path: '/syllabus', icon: Icons.syllabus },
      { name: 'Timetables', path: '/timetables', icon: Icons.timetable },
      { name: 'CogniCraft AI', path: '/ai-studio', icon: Icons.cogniCraft },
    ],
  },
  {
    title: 'System',
    links: [
      { name: 'Feedback', path: '/feedback', icon: Icons.feedback },
      { name: 'PrivacyPolicy', path: '/privacy', icon: Icons.privacy },
