...
const Sidebar: React.FC = () => {
    const { logout, isSidebarOpen, setSidebarOpen, user, isAiAvailable } = useAppContext();
                        ...
                        <div key={section.title}>
                            ...
                            {section.links.map((link) => {
                                ...
                                <NavLink
                                    ...
                                    className={({ isActive }) => `w-full flex items-center px-3 py-2.5 text-base font-medium rounded-lg transition-colors duration-200 ${
...
const AppContent: React.FC = () => {
  const { user, theme, toggleTheme, refreshDashboardStats } = useAppContext();
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-7xl mx-auto animate-fade-in">
             <Routes>
                ...
                <Route path="/settings" element={<SettingsPage user={user} theme={theme} toggleTheme={toggleTheme} />} />
                <Route path="/ai-studio" element={<NotebookLLMPage />} />
                <Route path="/" element={<Navigate to={user.pin === 'bhanu99517' ? "/manage-users" : "/dashboard"} replace />} />
